...
private val DarkColorScheme = darkColorScheme(
    primary = ColoresFit.Naranja,
    secondary = Color(0xFF9FB0C7),
    ...
    primaryContainer = Color(0xFF4A2A16),
    secondaryContainer = Color(0xFF263247),
    tertiaryContainer = Color(0xFF4A2A16),
    onPrimary = ColoresFit.Blanco,
    onSecondary = ColoresFit.Negro,
    onTertiary = ColoresFit.Blanco,
    onPrimaryContainer = Color(0xFFFFD7BF),
    onSecondaryContainer = Color(0xFFD8E4F7),
    onTertiaryContainer = Color(0xFFFFD7BF),
